...
import profileIcon from '../../frontend_assets/profile_icon.png'; // Asegúrate de reemplazar con la ruta real
import cartIcon from '../../frontend_assets/cart_icon.png'; // Asegúrate de reemplazar con la ruta real
